...
export default function HeroOrbit() {
  ...
  return (
    <div className="relative w-full max-w-lg aspect-square mx-auto select-none" id="hero-orbit-visual">
      ...
      {/* Center card: brand mark only, no invented metrics */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-[42%] aspect-square rounded-full glass-panel dark:glass-panel-dark shadow-xl flex items-center justify-center px-6">
